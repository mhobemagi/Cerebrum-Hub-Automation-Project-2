...
describe('Issue create', () => {
  ...
  it('Should create a RANDOM issue with type TASK and validate it successfully', () => {
    //System finds modal for creating issue and does next steps inside of it
    cy.get('[data-testid="modal:issue-create"]').within(() => {

      //Generate a random string of words in the description using the plugin
      //First set new values for title and description that will be used to generate values.
      const title = faker.word.verb(1);
      const description = faker.word.words(3);

      //Generate random string for description
      cy.get('.ql-editor').type(description);

      //Generate a random title using the plugin
